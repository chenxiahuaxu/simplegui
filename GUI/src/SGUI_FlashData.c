...
//=======================================================================//
static SGUI_INT         SGUI_Resource_GetCharIndex(SGUI_UINT32 uiCode);
static SGUI_CSZSTR      SGUI_Resource_StepNext(SGUI_CSZSTR cszSrc, SGUI_UINT32* puiCode);
static SGUI_BOOL        SGUI_Resource_IsFullWidth_ASCII(SGUI_UINT32 uiCode);
...
//	/*SGUI_INT                      iVerticalSpacing*/      0,
	/*SGUI_FN_IF_GET_CHAR_INDEX     fnGetIndex*/            SGUI_Resource_GetCharIndex,
	/*SGUI_FN_IF_GET_DATA           fnGetData*/             SGUI_FONT_RES_DATA_FUNC_NAME(8),
	/*SGUI_FN_IF_STEP_NEXT          fnStepNext*/            SGUI_Resource_StepNext,
	/*SGUI_FN_IF_IS_FULL_WIDTH      fnIsFullWidth*/         SGUI_Resource_IsFullWidth_ASCII
};
...
const SGUI_CBYTE SGUI_NOTICE_ICON_DATA[] = {
...
SGUI_INT SGUI_Resource_GetCharIndex(SGUI_UINT32 uiCode)
{
    /*----------------------------------*/
